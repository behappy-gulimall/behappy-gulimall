package org.xiaowu.behappy.cart.service.impl;
...
public class CartServiceImpl implements CartService {
    ...
    public CartItemVo addToCart(Long skuId, Integer num) throws ExecutionException, InterruptedException {
        ...
        if (StrUtil.isEmpty(productRedisValue)) {
            ...
            CompletableFuture<Void> getSkuAttrValuesFuture = CompletableFuture.runAsync(() -> {
                ...
                List<String> skuSaleAttrValues = r.getData(new TypeReference<List<String>>() {
                });
    ...
    public List<CartItemVo> getUserCartItems() {
        ...
        if (userInfoTo.getUserId() == null) {
            ...
            List<CartItemVo> cartItems = getCartItems(cartKey);
            if (cartItems == null) {
                throw new GulimallException(BizCodeEnum.EMPTY_CART_EXCEPTION);
            }
            //筛选出选中的
