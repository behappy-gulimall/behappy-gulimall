...
INSERT INTO `gulimall_wms`.`wms_ware_info`(`id`, `name`, `address`, `areacode`) VALUES (1681133447375093762, 'Behappy一号仓库', '阿尔卑斯山', '000000');


INSERT INTO `gulimall_wms`.`wms_ware_sku`(`id`, `sku_id`, `ware_id`, `stock`, `sku_name`, `stock_locked`) VALUES (1681133648068345858, 1, 1681133447375093762, 10, '华为 HUAWEI Mate 30 Pro 星河银 8GB+256GB', 0);
INSERT INTO `gulimall_wms`.`wms_ware_sku`(`id`, `sku_id`, `ware_id`, `stock`, `sku_name`, `stock_locked`) VALUES (1681133820290662401, 9, 1681133447375093762, 10, 'Apple iPhone 11 (A2223) 黑色 128GB', 0);
