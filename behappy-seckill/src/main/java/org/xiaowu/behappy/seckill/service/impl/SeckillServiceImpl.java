package org.xiaowu.behappy.seckill.service.impl;
...
import org.xiaowu.behappy.api.seckill.vo.SeckillSessionWithSkusVo;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    public void uploadSeckillSkuLatest3Days() {
        ...
        R latest3DaySession = couponFeignService.getLates3DaySession();
    ...
    public String kill(String killId, String key, Integer num) throws InterruptedException {
        ...
        if (StrUtil.isEmpty(skuInfoValue)) {
            return null;
        }
        //(合法性效验)
                ...
                if (count > 0 && num <= seckillLimit && count > num ) {
                    ...
                    if (Boolean.TRUE.equals(aBoolean)) {
                        ...
                        if (semaphoreCount) {
                            ...
                            String timeId = snowflake.nextIdStr();
